...
public class ApplicationConstants {
    ...
    public static final String errorMessageForLengthCompanies = "Validation error: Name is longer than 250 characters cannot POST https://api.cogmento.com/api/1/companies/ (400)";
